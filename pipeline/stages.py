...
SCRIPT_LONG = Stage(
    ...
    gate_sig=S.GateScriptLong,
    iter_sig=S.IterateScript,
    content_fields=["script"],
    topic_field="topic",
    weights={1: 5, 2: 4, 3: 3, 4: 2, 5: 1, 6: 1, 7: 12, 8: 12, 9: 13, 10: 18, 11: 14, 12: 15},  # D1 split 5/4/3/2/1/1; sums to 100
    labels={
        1: "package delivery (stakes/theme/arc/hook)",
        2: "payoff lands the WHY (desire+belief)",
        3: "desire constant, resurfaces",
        4: "belief on a spectrum",
        5: "authentic, not ego/proving",
        6: "team mirrors",
        7: "hook opens a loop",
        8: "head fake",
        9: "loops chain / no dead air",
        10: "immersive narration",
        11: "visceral & concrete",
        12: "the Dance (therefore/but, not and-then)",
    },
    ...
    kill_checks=(12,),    # the Dance moved from #7 to #12
)
